...
void setup() {
  ...
  //Red
  trackColor = color(111, 158, 190);

  //Green
  trackColor2 = color(116, 155, 181);

  //Blue
  trackColor3 = color(243, 219, 104);

  //Gelb
  trackColor4 = color(238,208, 102);
